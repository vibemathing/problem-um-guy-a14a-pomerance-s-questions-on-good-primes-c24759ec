...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A14a"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-v1",
      "problem_contract_sha256": "348adbf043ab67529ab903087babeac41e8e7d61f188333fa4b3efbffecf3b69",
      "problem_id": "problem:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec",
      "route_id": "route:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-source-fidelity-01",
      "graph_id": "graph:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Call prime $p_n$ good if $p_n^2 > p_{n-i}p_{n+i}$ for all $i$, $1 \\le i \\le n-1$. Is it true that the set of $n$ for which $p_n$ is good has density 0? Are there infinitely many $n$ with $p_n p_{n+1} > p_{n-i} p_{n+1+i}$ for all $i$, $1 \\le i \\le n-1$?"
          },
          "statement_sha256": "fe9baf1bbdba800a17a78c2e8afc0a7c8ba8747b869e4c5705f1ddaabba92bfd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-root",
      "route_id": "route:um-guy-a14a-pomerance-s-questions-on-good-primes-c24759ec-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a14a-f91d3056534b",
        "url": "https://www.unsolvedmath.com/problems/GUY-A14a"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
